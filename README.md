...
1. 정보검색 - 색인 기법 ([자료1](./documents/14.Introduction_to_Information_Retrieval.pdf)) ([자료2](./documents/15-1.Search_Engine_Architecture.pdf)) ([자료3](./documents/15-2.Crawler_and_Text_Analysis.pdf)) ([Code1](lecture14-2-정보검색_색인기법.ipynb):Code2에 포함되어 있음) ([Code2](lecture15-정보검색_색인기법(계속).ipynb))
1. 정보검색 - 가중치 기법
1. 정보검색 - 벡터 공간 모델
1. 정보검색 - 유사도 판별, 순위화
1. 특강
