...
1. 비정형 데이터 - HTTP, Urllib, Requests ([자료](./documents/02\.HTTP%20-%20비정형%20데이터%20-%20HTTP_Urllib_Requests.pdf)) ([Code](Code01-HTTP.ipynb))
...
1. 웹 크롤링 - DOM ([자료](./documents/05\.웹%20크롤링%20-%20DOM.pdf)) ([Code](Code02-DOM.ipynb))
1. 웹 크롤링 - Selector
1. 웹 스크래핑 - 정적 콘텐츠
1. 웹 스크래핑 - 동적 콘텐츠
