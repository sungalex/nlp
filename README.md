...
1. 형태소분석-POS_Taggers, 구문분석-구/연어/시각화 ([자료](./documents/13.POS-Parse_Tree.pdf)) ([Code1](lecture13-형태소분석_POS_Taggers-구문분석_구_연어_시각화.ipynb)) ([Code2](lecture14-1-parser_wordcloud.ipynb))
1. 정보검색 - 색인 기법 ([자료](./documents/14.Introduction_to_Information_Retrieval.pdf)) ([Code](lecture14-2-정보검색_색인기법.ipynb))
1. 정보검색 - 가중치 기법
1. 정보검색 - 벡터 공간 모델
1. 정보검색 - 유사도 판별, 순위화
1. 특강
